...
namespace DynamicPDFCreator.Pflichtfelder_Klassen
{
    ...
    {
        public static object[] PFLICHTFELDER = { EMPFAENGER, ORT, ANSPRECHPARTNER, WESI_TEAM };
        ...
        public static object[] FELDER = { EMPFAENGER, ORT, ANSPRECHPARTNER, WESI_TEAM, CHECKBOXEN,ZUSATZ };
    }
}
