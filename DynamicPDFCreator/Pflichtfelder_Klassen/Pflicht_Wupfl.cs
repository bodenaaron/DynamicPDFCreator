...
namespace DynamicPDFCreator.Pflichtfelder_Klassen
{
    ...
    { 
        ...
        public static object[] PFLICHTFELDER = { EMPFAENGER, ABSENDER, ANSPRECHPARTNER, ORT_DER_MASSNAHMEN, BESCHREIBUNG_DER_MASSNAHMEN, WESI_TEAM};
        public static object[] FELDER = { EMPFAENGER, ABSENDER, ANSPRECHPARTNER, ORT_DER_MASSNAHMEN, BESCHREIBUNG_DER_MASSNAHMEN, WESI_TEAM, CHECKBOXEN, ZUSATZ };
    }
}
