...
namespace DynamicPDFCreator
{
    class PDF
    {
        ...
        public PDF(TblAuftraege auftrag, TblAnschreibenTyp anschreibenTyp, TblAnsprechpartner empfaenger, TblBearbeiter absender, DateTime datum, DateTime ausfuehrungszeitraum, TblBearbeiter ansprechpartner, string ortDerMassnahme, string abgesprochenMit, string beschreibungMassnahme, TblAnsprechpartner ansprechpartnerBau, TblWesiTeam wesiTeam, bool plansaetze, bool listeBeteiligte, bool techBeschreibung, List<string>zusatzanlagen)
        {
